...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-black text-left text-base font-medium text-black bg-black focus:outline-none focus:text-black focus:bg-black focus:border-black transition duration-150 ease-in-out'
