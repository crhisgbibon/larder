  ...
  <div class="mx-auto w-full">
    ...
    <div class="flex flex-row items-center w-full bg-white border-b border-gray-100 justify-between sm:justify-center " style="min-height:calc(var(--vh) * 7.5)">
      ...
      <div class="flex w-full max-w-6xl flex-row justify-center mx-auto" style="height:calc(var(--vh) * 7.5)">
        <a id="LogButton" href="{{ url('/log') }}" class="h-full flex justify-center items-center mx-2 active:scale-95">
          <img class="w-3/4 h-3/4" src="{{ asset('storage/Assets/calendarLight.svg') }}">
        </a>
        <a id="FoodsButton" href="{{ url('/foods') }}" class="h-full flex justify-center items-center mx-2 active:scale-95">
          <img class="w-3/4 h-3/4" src="{{ asset('storage/Assets/coffeeLight.svg') }}">
        </a>
        <a id="RecipesButton" href="{{ url('/recipes') }}" class="h-full flex justify-center items-center mx-2 active:scale-95">
          <img class="w-3/4 h-3/4" src="{{ asset('storage/Assets/bowl.svg') }}">
        </a>
        <a id="ProfileButton" href="{{ url('/user') }}" class="h-full flex justify-center items-center mx-2 active:scale-95">
